...
class JsonSecuritySpec extends PlaySpec {
  ...
  class Setup {
    ...
    val testAccData = UserRegister("testFirstName","testLastName","testUserName","test@email.com","testPassword", "testPassword")
  }
  ...
  "Enc and Dec a model" should {
    ...
    "return a live system UserAccount model" in new Setup {
      val enc = TestSec.encryptModel[UserRegister](testAccData)
      val dec = TestSec.decryptInto[UserRegister](enc.get)
